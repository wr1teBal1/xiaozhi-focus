...
void OLED_WriteCommand(uint8_t Command)
{
    ...
    // OLED_I2C_Stop();				//I2C终止
    HAL_I2C_Mem_Write(&hi2c1, OLED_W_ADDR, OLED_COMMAND_BYTE, 
                    I2C_MEMADD_SIZE_8BIT, &Command, 1, OLED_TIMEOUT);
}
...
void OLED_WriteData(uint8_t *Data, uint8_t Count)
{
    ...
    // OLED_I2C_Stop();				//I2C终止
    HAL_I2C_Mem_Write(&hi2c1, OLED_W_ADDR, OLED_COMMAND_BYTE, 
        I2C_MEMADD_SIZE_8BIT, Data, Count, OLED_TIMEOUT);
}
...
void OLED_Display(const uint8_t *Display)
{
    OLED_ShowImage(64, 2, 60, 60, Display);
    OLED_Update();
}
/**
